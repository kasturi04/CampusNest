...
> **Smart Hostel Management & Intelligent Room Allocation System**  
> Developed by Team **Quantum Minds** from **Kakinada Institute of Engineering & Technology (KIET)**.
...
The platform is built on a lightweight, modular MVC pattern ensuring fast response times and clear separation of concerns:
...
│
▼
[Frontend UI: HTML, CSS, Bootstrap, JS]
│
▼
[Flask Backend Application Engine]
│
▼
...
### Prerequisites
Make sure you have **Python 3.8+** and **Git** installed on your local computer.

### Installation
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/your-username/CampusNest.git](https://github.com/your-username/CampusNest.git)
   cd CampusNest
